...
class TestProjectTimesheetTimeControl(common.TransactionCase):
    ...
    def test_aal_time_control_flow(self):
        ...
        self.assertEqual(wizard.running_timer_ids, running_timer)
    ...
    def test_project_time_control_flow(self):
        ...
        self.assertFalse(wizard.running_timer_ids, self.line)
    ...
    def test_wizard_standalone(self):
        ...
        self.assertEqual(wizard.running_timer_ids, self.line)
        ...
        self.assertFalse(wizard.running_timer_ids)
